...
const STRINGS = {
  en: {
    ...
    cfgCutaway:     'Cutaway height',
    helpCutaway:    'Slices the render at a given height: outer walls open up and you look inside, like a doll house. Also removes an exported ceiling. Anchors stay visible.',
    cutawayOff:     'off',
  ...
  fr: {
    ...
    cfgCutaway:     'Hauteur de coupe',
    helpCutaway:    "Tranche le rendu à une hauteur donnée : les murs extérieurs s'ouvrent et l'on voit à l'intérieur, comme dans une maison de poupée. Retire aussi un plafond exporté. Les ancres restent visibles.",
    cutawayOff:     'aucune',
